...
public class NetheriteSkilletRenderer implements BlockEntityRenderer<NetheriteSkilletBlockEntity>
{
	private final Random random = new Random();

	public NetheriteSkilletRenderer(BlockEntityRendererProvider.Context context) {
	}

	@Override
	public void render(NetheriteSkilletBlockEntity skilletEntity, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int combinedLight, int combinedOverlay) {
