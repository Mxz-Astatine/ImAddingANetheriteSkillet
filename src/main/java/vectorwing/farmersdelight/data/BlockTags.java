...
public class BlockTags extends FabricTagProvider.BlockTagProvider
{
	...
	protected void registerBlockMineables() {
        ...
        tagBuilder(ModTags.MINEABLE_WITH_KNIFE).add(
						Blocks.CACTUS,
						Blocks.MELON,
						Blocks.PUMPKIN,
	...
	protected void registerCommonTags() {
		tagBuilder(CommonTags.MINEABLE_WITH_KNIFE);
		tagBuilder(ConventionalBlockTags.STORAGE_BLOCKS)
	...
	protected void registerModTags() {
		...
		tagBuilder(ModTags.WILD_CROPS).add(
				ModBlocks.WILD_CARROTS.get(),
				ModBlocks.WILD_POTATOES.get(),
				ModBlocks.WILD_BEETROOTS.get(),
				ModBlocks.WILD_CABBAGES.get(),
		...
		tagBuilder(ModTags.UNAFFECTED_BY_RICH_SOIL).add(
						Blocks.GRASS_BLOCK,
						Blocks.SHORT_GRASS,
						Blocks.MOSS_BLOCK,
		...
		tagBuilder(ModTags.MUSHROOM_COLONY_GROWABLE_ON).add(ModBlocks.RICH_SOIL.get());
		tagBuilder(ModTags.DROPS_CAKE_SLICE).add(
				Blocks.CANDLE_CAKE,
		...
		tagBuilder(ModTags.CAMPFIRE_SIGNAL_SMOKE).add(ModBlocks.STRAW_BALE.get()).add(ModBlocks.RICE_BALE.get());
	}
